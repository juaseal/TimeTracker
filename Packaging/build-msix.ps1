...
$output=Join-Path $root "artifacts\TimeTracker-$Version-$architecture.msix"
...
if(-not $makeAppx){throw "No se encontró makeappx.exe. Instala Windows SDK desde Visual Studio Installer."}
